        ...
        <div
            ...
            <div className="text-left p-4">
                <h1 className="text-3xl md:text-3xl font-extrabold text-gray-500 dark:text-gray-300 mb-6">
                    {time.toLocaleDateString()} {/* 显示年月日 */}
                </h1>
                <h2 className="text-6xl md:text-9xl font-semibold font-mono text-indigo-700 dark:text-indigo-300">
                    {time.toLocaleTimeString()} {/* 显示时间 */}
                </h2>
            </div>
        </div>
    );
